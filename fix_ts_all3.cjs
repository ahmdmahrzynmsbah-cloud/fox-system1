...
ftContent = ftContent.replace(/printTargetReceipt\.date/g, "printTargetReceipt.payment_date");
ftContent = ftContent.replace(/printTargetReceipt\.category === 'book'/g, "printTargetReceipt.category === ('book' as any)");
ftContent = ftContent.replace(/printTargetReceipt\.category === 'exam'/g, "printTargetReceipt.category === ('exam' as any)");
