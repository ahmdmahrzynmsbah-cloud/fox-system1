...
const renderReplacement = `  if (showPrintModal && activeEvaluationObj) {
    ...
    return (
      <div className="bg-white p-6 rounded-3xl animate-fade-in" dir="rtl">
        ...
        <div id="printable-group-roster" className="bg-white text-slate-900 font-sans p-2">
          {/* Header */}
          <div className="flex items-center justify-between border-b-2 border-[#0d5c8c] pb-4 mb-4">
            ...
            <div className="text-left bg-slate-50 p-3 rounded-xl border border-slate-200 shadow-sm print:bg-transparent print:border-none print:shadow-none">
          ...
          {/* Meta Grid */}
          <div className="grid grid-cols-3 gap-3 bg-slate-50 border border-slate-200 p-4 rounded-xl mb-4 text-sm print:bg-transparent">
          ...
          <div className="grid grid-cols-5 gap-3 mb-6">
            <div className="bg-slate-100 border border-slate-300 p-3 rounded-xl text-center flex flex-col print:bg-transparent">
            ...
            <div className="bg-emerald-50 border border-emerald-200 p-3 rounded-xl text-center flex flex-col print:bg-transparent">
            ...
            <div className="bg-rose-50 border border-rose-200 p-3 rounded-xl text-center flex flex-col print:bg-transparent">
            ...
            <div className="bg-amber-50 border border-amber-200 p-3 rounded-xl text-center flex flex-col print:bg-transparent">
            ...
            <div className="bg-sky-50 border border-sky-200 p-3 rounded-xl text-center flex flex-col print:bg-transparent">
          ...
          <table className="w-full text-sm text-center border-collapse">
            <thead>
              <tr className="bg-[#0d5c8c] text-white print:text-black">
                <th className="p-2 border border-slate-300 print:bg-slate-100">م</th>
                <th className="p-2 border border-slate-300 print:bg-slate-100">رقم القيد</th>
                <th className="p-2 border border-slate-300 text-right print:bg-slate-100">اسم الطالب</th>
                <th className="p-2 border border-slate-300 print:bg-slate-100">الحالة</th>
                <th className="p-2 border border-slate-300 print:bg-slate-100">الدرجة</th>
                <th className="p-2 border border-slate-300 print:bg-slate-100">النسبة</th>
                <th className="p-2 border border-slate-300 print:bg-slate-100">التقدير</th>
                <th className="p-2 border border-slate-300 print:bg-slate-100">ملاحظات</th>
              </tr>
            </thead>
            <tbody>
                ...
                return (
                  <tr key={student.id} className="border-b border-slate-200 hover:bg-slate-50">
                    ...
                    <td className="p-2 border border-slate-300">
                      {isAbsentOrMissing 
                        ? <span className="text-rose-700 font-bold">{gradingType === 'exam' ? 'غائب' : 'لم يسلم'}</span>
                        : <span className="text-emerald-700 font-bold">{gradingType === 'exam' ? 'حاضر' : 'تم التسليم'}</span>
                      }
                    </td>
